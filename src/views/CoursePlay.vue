...
let route = useRoute()
// api 播放视频
import {play,recordHistory,getLastHistoryByChapterId} from '@/utils/api/login'
...
onBeforeMount(()=>{
     play({
        ...
        // 课程名称
        courseInfo.value = res.data.courseInfo.courseName
        options.title = res.data.courseInfo.courseName
        //课程章节和小节
